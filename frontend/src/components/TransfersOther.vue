...
<div class="container">
  <div class="left">
    <div class="header">
      <h2 class="animation a1 mb-5">Transfers to Other Accounts</h2>
    ...
    <div class="user-box">
      <input v-model="toAccount" type="text" name="" required="" maxlength="10" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" aria-label="input the mail" aria-describedby="button-addon1"/>
...
data() {
  ...
  methods:{
    ...
    if(this.amountSelected == "" || this.amountSelected == "$00.00" ||  parseFloat(this.amountSelected) < monto.balance){
